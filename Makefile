...
pgada-database.o pgada-database.ali:\
...
pgada-errors.o pgada-errors.ali:\
...
obj_clean:
	...
	install.a installer installer.o instchk instchk.o insthier.o pgada-conf \
	pgada-conf.o pgada-database.ali pgada-database.o pgada-errors.ali \
